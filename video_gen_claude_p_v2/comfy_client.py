...
Copied from video_gen_claude_p (v1)'s comfy_client.py -- unchanged content,
just made part of this self-contained package.

Endpoint/content-type details here follow the LIVE /openapi.json of the
server, cross-checked against the markdown doc: /flux/generate is
application/x-www-form-urlencoded (no files) -- the live schema is
authoritative there, the doc says multipart but openapi.json still says
urlencoded.
